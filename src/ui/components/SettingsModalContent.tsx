            ...
            <div className="space-y-4">
              <div className="space-y-1">
                ...
                <p className="text-small text-default-400">
                  The folder where downloaded Splice samples should be saved to.
                  When dragging samples into a DAW, this will be the directory
                  it will read from.
                </p>
              </div>
              ...
              <div className="space-y-1">
                ...
                <p className="text-small text-default-400">
                  While downloading samples, Splicedd has the ability to create
                  placeholder files, which will be replaced when the downloading
                  finishes. This avoids the need to wait before
                  drag-and-dropping is allowed, but might cause issues in
                  certain DAWs.
                </p>
              </div>
              ...
              <div>
                <Switch
                  ...
                  onValueChange={(x) => mutateCfgSync(x, placeholders)}
                >
                  Enable placeholders
                </Switch>
              </div>
